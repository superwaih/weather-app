...
const mapboxAPIKey = "pk.eyJ1IjoicnRkLXN1cGVybWFuIiwiYSI6ImNreTZ3bG03YjAzMTgyd2xqMWtrd2k2cm0ifQ.4VY5RaXBQD2En3LY1VlD4w"
...
<template>
    <main class="container text-white">
        <div class="pt-4 mb-8 relative">
            ...
            <ul class="absolute bg-weather-secondary text-white shadow-md py-2 px-1 w-full top-[66px]"
